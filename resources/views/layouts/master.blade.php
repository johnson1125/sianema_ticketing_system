        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase text-white">Movies</h2>
                        <ul class="text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="{{ route('movies') }}" class="hover:underline ">Showing Now</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm sm:text-center text-gray-400">© 2023 <a href="{{ route('home') }}" class="hover:underline">Sianema™</a>. All Rights Reserved.
                </span>
