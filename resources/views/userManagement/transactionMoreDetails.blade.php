...
<div class="container">
    <div class="card-container p-6 bg-gray-600   rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <!-- <a href="{{ url()->previous() }}"
                ...
                Back</a> -->
        <div class="back-link">
            <a href="{{ route('transactionHistory') }}" class="btn-back btn-primary focus:outline-none text-white  focus:ring-4 focus:ring-sianema-green font-extrabold rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Back</a>
        </div>
    </div>
